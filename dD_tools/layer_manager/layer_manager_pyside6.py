...
from PySide6.QtWidgets import QApplication, QWidget, QHBoxLayout, QTabWidget, QListWidget, \
...
from PySide6.QtGui import QColor, QIcon, QKeySequence, QDesktopServices
